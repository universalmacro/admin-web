        ...
        {routeConifg?.map((route: any) => {
          return (
            <>
              ...
              <ul className="pt-1">
                <Links
                  routes={route?.children?.filter((item: any) => item?.hidden !== true)}
                  id={id}
                />
              </ul>
